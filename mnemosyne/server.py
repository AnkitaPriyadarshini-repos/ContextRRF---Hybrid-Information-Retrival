...
from mnemosyne.ranking import rrf_fuse, DEFAULT_RRF_WEIGHTS
...
def _get_store(project_root: Path) -> Store:
    ...
    mnemosyne_dir = project_root / ".mnemosyne"
    mnemosyne_dir.mkdir(parents=True, exist_ok=True)
    db_path = mnemosyne_dir / "mnemosyne.db"
...
class ContextRRFRequestHandler(BaseHTTPRequestHandler):
    ...
    def handle_get_stats(self) -> None:
        ...
        db_file = PROJECT_ROOT / ".mnemosyne" / "mnemosyne.db"
