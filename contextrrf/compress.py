...
"""
Context compression engine for ContextRRF.

The :class:`Compressor` applies a four-stage pipeline to reduce a
:class:`~contextrrf.models.Chunk`'s token count while preserving the
...
class Compressor:
    ...
    Args:
        ...
        tfidf_backend: Optional :class:`~contextrrf.embeddings.tfidf_backend.TFIDFBackend`
    ...
    def compress(
        ...
        Args:
            chunk:       The :class:`~contextrrf.models.Chunk` to compress.
