...
class TestDocxExtractor:
    ...
    def test_extract_basic(self):
        from contextrrf.extractors import docx_extractor
...
class TestCsvExtractor:
    ...
    def test_extract_csv_with_header(self):
        from contextrrf.extractors import csv_extractor
...
class TestPlaintextExtractor:
    ...
    def test_extract_log_file(self):
        from contextrrf.extractors import plaintext_extractor
...
class TestBaseHelpers:
    ...
    def test_classify_quality_good(self):
        from contextrrf.extractors.base import classify_quality
    ...
    def test_extracted_content_full_text(self):
        from contextrrf.extractors.base import ExtractedContent, ExtractedPage
...
class TestExtractorDispatch:
    ...
    def test_get_extractor_docx(self):
        from contextrrf.extractors import get_extractor
    ...
    def test_supported_extensions_includes_pdf(self):
        from contextrrf.extractors import supported_extensions
