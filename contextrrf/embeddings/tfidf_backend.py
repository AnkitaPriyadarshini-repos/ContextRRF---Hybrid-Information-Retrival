...
"""
Pure-Python TF-IDF sparse embedding backend for ContextRRF.
...
from contextrrf.embeddings.stemmer import stem as _porter_stem
    ...
    def search(self, query: str, top_k: int = 20) -> list[tuple[int, float]]:
        ...
        if self._vocabulary_stale:
            logger.warning(
                ...
                "Run `contextrrf ingest --full` to rebuild."
            )
            return []
