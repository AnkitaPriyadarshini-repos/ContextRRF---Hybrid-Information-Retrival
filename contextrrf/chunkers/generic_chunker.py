...
"""
Sliding-window fallback chunker for ContextRRF.

Used for any language that the :class:`~contextrrf.chunkers.code_chunker.CodeChunker`
and :class:`~contextrrf.chunkers.text_chunker.TextChunker` do not handle
