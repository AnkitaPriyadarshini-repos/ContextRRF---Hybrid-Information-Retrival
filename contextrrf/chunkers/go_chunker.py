...
"""
Go-aware structural chunker for ContextRRF.
...
source.  Built on top of :class:`~contextrrf.chunkers.brace_chunker.BraceChunker`.
"""
...
from contextrrf.chunkers.brace_chunker import BraceChunker, DeclPattern
