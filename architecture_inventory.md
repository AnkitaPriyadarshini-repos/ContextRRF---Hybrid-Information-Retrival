...
| 23 | **MCP Integration** | [`mcp/src/mnemosyne_mcp/server.py`](file:///c:/Users/ankit/ContextRRF/mcp/src/mnemosyne_mcp/server.py) | Model Context Protocol (MCP) server integration bringing ContextRRF tools directly into Anthropic Claude / IDE hosts. |
