...
"""
Embedding backend registry for ContextRRF.

Selects and returns the best available embedding backend based on configuration.
The only built-in backend is :class:`~contextrrf.embeddings.tfidf_backend.TFIDFBackend`,
...
def get_dense_backend(config: "Config", store=None, model_dir: str | None = None):
    ...
    Returns:
        A :class:`~contextrrf.embeddings.dense_backend.DenseBackend` instance,
