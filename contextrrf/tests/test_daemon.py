...
"""
Tests for the ContextRRF JSON-RPC daemon.
...
class _DaemonTestBase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.contextrrf_dir = os.path.join(self.tmp_dir, ".contextrrf")
        os.makedirs(self.contextrrf_dir)
...
class TestDaemonStartForegroundAndQuery(_DaemonTestBase):
    ...
    def test_query_returns_results(self):
        ...
        bloom = BloomFilter()
        audit_path = os.path.join(self.contextrrf_dir, "audit.log")
