...
"""
End-to-end integration test for the ContextRRF context engine.
...
```bash
pip install contextrrf
contextrrf index .
contextrrf query "authentication middleware"
```

## Configuration

Create `.contextrrf/config.toml` in your project root:
...
class TestEndToEnd(unittest.TestCase):
    ...
    def setUp(self):
        ...
        audit_path = os.path.join(self.tmp_dir, ".contextrrf", "audit.jsonl")
