...
"""CLI entry point for contextrrf-ollama."""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="contextrrf-ollama",
        description="Ask your codebase questions using Ollama and ContextRRF.",
    )
    ...
    from contextrrf_ollama import __version__
...
def _run_single(args: argparse.Namespace) -> None:
    from contextrrf_ollama.agent import run
...
def _run_interactive(args: argparse.Namespace) -> None:
    ...
    from contextrrf_ollama.agent import (
    ...
    print(f"contextrrf-ollama interactive ({model})")
    ...
    async def _session():
        ...
        try:
            ...
            print("Error: contextrrf-mcp not found. Install: pip install contextrrf-mcp", file=sys.stderr)
            return
