...
"""
In-memory ANN vector store abstraction for ContextRRF.
...
:class:`~contextrrf.embeddings.tfidf_backend.TFIDFBackend`).  If a future
...
class VectorStore:
    ...
    :meth:`~contextrrf.embeddings.tfidf_backend.TFIDFBackend.embed`.
